...
public class AmazonSearch_RetryAnalyzer {
  ...
  @Test(priority=3,retryAnalyzer=com.testng1.IRetryAnalyzer_Listener.class)
  public void getPageInfo() {
	    ...
	    Assert.assertEquals(title, " Shopping site in India: Shop Online for Mobiles, Books, Watches, Shoes and More - Amazon.in");
  ...
  @Test(priority=5,retryAnalyzer=com.testng1.IRetryAnalyzer_Listener.class)
